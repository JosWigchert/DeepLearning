...
balanced_data = pd.read_csv("balanced_data_50hz.csv") 
#balanced_data = balanced_data.append([Walking, Running])
...
### Standardize data
X = balanced_data[['X data','Y data','Z data']]
...
X_train = X_train.reshape(970, 100, 3, 1)
X_test = X_test.reshape(243, 100, 3, 1)
